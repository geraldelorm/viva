...
{    
     ...
     $sql = "INSERT INTO drivers (name,email,phone)
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="adddriver.php">Add Drivers</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>Phone</label>
                                                    <input type="mobile" name="phone" class="form-control" placeholder="PHONE">
                                                </div>
                                            </div>
                                        </div>
