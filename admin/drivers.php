...
<?php
    ...
    $fetch = mysqli_query($link, "select * from drivers" );
                    ...
                    <ul id="sidebarnav">
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="#"
                                aria-expanded="false"><i data-feather="user" class="feather-icon"></i><span
                                    class="hide-menu">DRIVERS</span></a></li>
                        <li class="list-divider"></li>
                        <li class="nav-small-cap"><span class="hide-menu">VIEW BOOKINGS AND MORE</span></li>

                        <li class="sidebar-item"> <a class="sidebar-link" href="welcome.php"
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="drivers.php">Drivers</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xlg-6">
                                        <div class="card card-hover">
                                            <div class="p-2 bg-success text-center">
                                                ...
                                                <h6 class="text-white">At Station</h6>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Column -->
                                    <div class="col-md-6 col-lg-6 col-xlg-6">
                                        <div class="card card-hover">
                                            <div class="p-2 bg-danger text-center">
                                                ...
                                                <h6 class="text-white">On A Trip</h6>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Column -->
